...
South2Cone::South2Cone(SwerveDrive* drive, Superstructure* superstructure, bool isBlue) {
...
frc::Pose2d South2Cone::GetStartingPose(bool isBlue) {
  static auto blueStartingPose = TrajectoryManager::GetInstance().GetTrajectory("blue-south-2cone_0_place1").GetInitialPose();
  static auto redStartingPose = TrajectoryManager::GetInstance().GetTrajectory("red-south-2cone_0_place1").GetInitialPose();
