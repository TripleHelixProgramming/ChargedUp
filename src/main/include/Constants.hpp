...
// const frc::Transform3d kRobotToCam(frc::Translation3d(-11_in, 0_in, 24.865_in),
//                                    frc::Rotation3d(0_deg, 0_deg, 0_deg));

// Left side camera on 2023 robot
const frc::Transform3d kRobotToCam(frc::Translation3d(11.25_in, 13.25_in, 24.865_in),
