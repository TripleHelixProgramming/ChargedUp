...
class Vision : public frc2::SubsystemBase {
 ...
 private:
  ...
  cv::Mat m_cameraMatrix =
      (cv::Mat_<double>(3, 3) <<
           // Global shutter camera left after feb 14
            737.1375625617618, 0.0, 605.0596973248307, 0.0, 737.332104946256, 326.2280047911644, 0.0, 0.0, 1.0
  ...
  cv::Mat m_distortionCoefficients =
      (cv::Mat_<double>(5, 1) <<
           ...
           0.048988140593189386, 0.1507107694319857, -0.0013521811213351104, -8.674674516252695E-4, -0.2012522991632792
       // Josh's XPS 13 webcam
