 ...
 private:
  ...
  cv::Mat m_cameraMatrix =
      (cv::Mat_<double>(3, 3) <<
           // Left camera
    //        737.1375625617618,
    //    0.0, 605.0596973248307, 0.0, 737.332104946256, 326.2280047911644, 0.0,
    //    0.0, 1.0
            // Right camera
            742.483468466319, 0.0, 637.2421086110966, 0.0, 741.833232408462, 401.5930628745256, 0.0, 0.0, 1.0
  ...
  cv::Mat m_distortionCoefficients =
    ...
    //    0.1507107694319857, -0.0013521811213351104, -8.674674516252695E-4,
    //    -0.2012522991632792
            // Right camera
            0.10050662325551381, -0.048995749738143635, -0.0014568776758625078, 0.0012852294132110506, -0.15731800217755504
       // Josh's XPS 13 webcam
