...
class Vision : public frc2::SubsystemBase {
 ...
 private:
  ...
  cv::Mat m_cameraMatrix = (cv::Mat_<double>(3, 3) <<
                            ...
                            // 715.4570872534645, 0.0, 503.2741860156487, 0.0, 718.1743279814092, 319.62675877827525, 0.0, 0.0, 1.0
                            );
  cv::Mat m_distortionCoefficients =
      (cv::Mat_<double>(5, 1) <<
       ...
       -0.10751011668818884
       // Josh's XPS 13 webcam
    // -0.1993374890518083, 1.056200497191576, 0.009578356882858418, 0.008707188436370845, -1.5919105322821563
